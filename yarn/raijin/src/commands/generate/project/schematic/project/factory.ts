...
import type { State }                    from './factory.interfaces.js'

import { MergeStrategy }                 from '@angular-devkit/schematics'
import { chain }                         from '@angular-devkit/schematics'
import { mergeWith }                     from '@angular-devkit/schematics'

import { mergeGitIgnoreContent }         from '../gitignore/merge.js'
import { updateServiceStartScripts }     from '../manifest/start-scripts.js'
...
const captureGitIgnoreContentRule = (state: State): Rule =>
  (host: Tree): Tree => {
...
const mergeGitIgnoreContentRule = (state: State): Rule =>

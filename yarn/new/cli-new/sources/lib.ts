import {
  CommandContext, Configuration, miscUtils, PluginConfiguration, semverUtils, TelemetryManager,
  YarnVersion,
}                                              from '@yarnpkg/core'
...
async function run(cli: YarnCli, argv: Array<string>, { selfPath, pluginConfiguration }: {
  selfPath: PortablePath | null,
  pluginConfiguration: PluginConfiguration
}) {
...
export async function getCli({
  cwd = ppath.cwd(), pluginConfiguration = getPluginConfiguration(),
...
export async function runExit(argv: Array<string>, {
  cwd = ppath.cwd(), selfPath, pluginConfiguration,

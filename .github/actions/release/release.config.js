...
export default {
  ...
  plugins: [
    ...
    [
      ...
      {
        prepareCmd:
          'yarn workspace @atls/raijin version ${nextRelease.version} --immediate && yarn cli:build',
        publishCmd:
        ...
        successCmd:
          'YARN_NPM_AUTH_TOKEN="$NPM_TOKEN" YARN_NPM_REGISTRY_SERVER=https://registry.npmjs.org yarn npm tag add @atls/raijin@${nextRelease.version} latest',
      },
    ],
    [
      '@semantic-release/github',
      {
        ...
        assets: [{ path: '.yarn/releases/yarn.js', name: 'yarn.js' }],
      },
    ],
  ],
}

...
class Project {
    ...
    async loadUserConfig() {
        const configPath = fslib_2.ppath.join(this.cwd, `yarn.config.js`);
 ...
 */
function applyVirtualResolutionMutations({ project, allDescriptors, allResolutions, allPackages, accessibleLocators = new Set(), optionalBuilds = new Set(), peerRequirements = new Map(), volatileDescriptors = new Set(), report, }) {
    var _a;

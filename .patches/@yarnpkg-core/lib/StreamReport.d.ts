...
export declare class StreamReport extends Report {
    ...
    constructor({ configuration, stdout, json, includeNames, includePrefix, includeFooter, includeLogs, includeInfos, includeWarnings, forgettableBufferSize, forgettableNames, }: StreamReportOptions);
    hasErrors(): boolean;
    exitCode(): 1 | 0;

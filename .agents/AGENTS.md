...
- code review: `.agents/pipelines/code-review.md` (ревью PR строго по шагам, без самодеятельности)

## Mobile

### Platform guidelines

- Android: `.agents/instructions/mobile/guideline_android.md`
- KMP/CMP: `.agents/instructions/mobile/guideline_kmp.md`

### Project-specific

- `.agents/instructions/mobile/project_specific.md`

## Общие принципы

- сначала узнать контекст проекта, проверить соглашения и изучить структуру аналогичных фич
- перед правками искать по репозиторию (`rg` (если нет - `grep -R`), `ls`, `cat`), не придумывать структуру и правила

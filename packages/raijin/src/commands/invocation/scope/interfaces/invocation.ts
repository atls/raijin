...
import type { ApplicationInvocation }    from '../../capabilities/interfaces/application.js'
import type { ProcessInvocation }        from '../../capabilities/interfaces/process.js'
import type { ProjectProcessInvocation } from '../../capabilities/interfaces/process.js'
import type { YarnRuntimeInvocation }    from '../../capabilities/interfaces/yarn.js'

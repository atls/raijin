import type { ExecuteInput }                          from '../index.js'
import type { ExecuteResult }                         from '../index.js'
import type { Executor }                              from '../index.js'
import type { ExecuteResult as ProcessExecuteResult } from '../subprocess/execute.interfaces.js'
import type { ExecutorOptions }                       from './interfaces/executor.js'

import { isManagedNodeEnvironmentName } from '../../runtime/node/loader/environment.js'
import { removeEnvironmentMarkers } from '../../runtime/node/loader/environment.js'
import { removeAppliedLoaderRegistration } from '../../runtime/node/loader/environment.js'
import { create as createRegistrationImport } from '../../runtime/node/loader/registration.js'
import { execute as executeProcess }                  from '../subprocess/execute.js'

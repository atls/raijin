...
var TestCommand = (function (_super) {
    ...
    TestCommand.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reportPath, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reportPath = join(tmpdir(), "jest-report-" + new Date().getTime() + ".json");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 5]);
                        return [4, execa('jest', [
    ...
    TestCommand.prototype.check = function (_a) {
        var testResults = _a.testResults;
        return __awaiter(this, void 0, void 0, function () {
            var cwd, assertions, annotations;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        cwd = process.env.GITHUB_WORKSPACE || process.cwd();
                        assertions = testResults
                            .reduce(function (result, testResult) { return __spreadArrays(result, testResult.assertionResults.map(function (assertion) { return (__assign(__assign({}, assertion), { path: testResult.name.substring(cwd.length + 1) })); })); }, [])
                            .filter(function (assertion) { return assertion.status === 'failed'; });
                        annotations = assertions.map(function (assertion) { return ({
                            path: assertion.path,
                        ...
                        return [4, createCheck('Test', annotations.length > 0 ? Conclusion.Failure : Conclusion.Success, {

...
var AllCommand = (function (_super) {
    ...
    AllCommand.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        commands = [CommitLintCommand, LintCommand, TestCommand, TypecheckCommand];
                        return [4, Promise.all(commands.map(function (command) { return __awaiter(_this, void 0, void 0, function () {
                                var error_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:

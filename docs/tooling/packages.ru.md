...
- Зависимости: deps 1, devDeps 4, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 1, devDeps 3, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 0, devDeps 6, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 0, devDeps 13, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 4, devDeps 6, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 9, devDeps 5, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 4, devDeps 2, peerDeps 0
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 3, devDeps 6, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 2, devDeps 7, peerDeps 2
...
- Назначение: CLI UI-компонент для терминального интерфейса
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 5, devDeps 4, peerDeps 2
...
- Группа: `prettier`
- Видимость: `public`
- Назначение: Prettier-плагин и форматирование
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `webpack`
- Видимость: `public`
- Назначение: Webpack интеграция для экосистемы tools
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Вспомогательная утилита экосистемы yarn
- Скрипты: отсутствуют
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена badges
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена changelog
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 2, devDeps 3, peerDeps 2
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена check
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена checks
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена cli-publish
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена commit
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена essentials
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена export
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена files
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена format
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена image
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена jsr
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 2, devDeps 4, peerDeps 3
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена library
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена lint
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена pnp-patch
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена release
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 3, devDeps 3, peerDeps 2
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена renderer
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 3, devDeps 8, peerDeps 2
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена schematics
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена service
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена test
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена tools
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена typescript
- Скрипты: `build`, `postpack`, `prepack`
- Зависимости: deps 11, devDeps 7, peerDeps 2
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена ui
- Скрипты: `build`, `postpack`, `prepack`
...
- Группа: `yarn`
- Видимость: `private`
- Назначение: Yarn-плагин для домена workspaces
- Скрипты: `build`, `postpack`, `prepack`

...
- Group: `prettier`
- Visibility: `public`
- Purpose: Prettier plugin and formatting utilities
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `webpack`
- Visibility: `public`
- Purpose: Webpack integration for tools ecosystem
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for badges domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for changelog domain
- Scripts: `build`, `postpack`, `prepack`
- Dependencies: deps 2, devDeps 3, peerDeps 2
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for check domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for checks domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for cli-publish domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for commit domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for essentials domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for export domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for files domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for format domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for image domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for jsr domain
- Scripts: `build`, `postpack`, `prepack`
- Dependencies: deps 2, devDeps 4, peerDeps 3
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for library domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for lint domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for pnp-patch domain
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for release domain
- Scripts: `build`, `postpack`, `prepack`
- Dependencies: deps 3, devDeps 3, peerDeps 2
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for renderer domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for schematics domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for service domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for test domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for tools domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for typescript domain
- Scripts: `build`, `postpack`, `prepack`
- Dependencies: deps 11, devDeps 7, peerDeps 2
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for ui domain
- Scripts: `build`, `postpack`, `prepack`
...
- Group: `yarn`
- Visibility: `private`
- Purpose: Yarn plugin for workspaces domain
- Scripts: `build`, `postpack`, `prepack`

...
| Project test execution            | `packages/plugins/test` with `@atls/raijin` managed execution | Current   | #839 established one result for the general, unit, integration, and checks consumers                                            |
